...
function selectRandom(array) {
  ...
  let index = Math.random() * (endOfArray - begOfArray) + begOfArray; //9.9
...
const revealMistery = (generatedRandObj) => {
...
revealMistery(pickMystery); // pickMistery function passed as parameter